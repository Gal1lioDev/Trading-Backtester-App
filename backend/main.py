...
async def run_strategy_backtest(
    ...
    # Optional strategy JSON created by the frontend (stringified)
    ...
    try:
        ...
        if strategy:
            try:
                ...
                buy_condition = parsed.get('buy_condition', buy_condition) or buy_condition
                sell_condition = parsed.get('sell_condition', sell_condition) or sell_condition
                stock_symbol = parsed.get('symbol', stock_symbol) or stock_symbol
                # allow indicator periods to be provided
